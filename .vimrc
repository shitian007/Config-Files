...
au BufNewFile,BufRead *.js set expandtab tabstop=2 autoindent shiftwidth=2 autoindent
au BufNewFile,BufRead *.css set expandtab tabstop=2 autoindent shiftwidth=2 autoindent
